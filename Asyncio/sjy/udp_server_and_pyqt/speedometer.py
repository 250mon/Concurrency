...
"""
The logic of asyncio is that everything uses an eventloop
as a base, and by default Qt does not support it.
So you must use libraries such as
qasync(python -m pip install qasync) and
    ...
    def drawMarkings(self, painter):
        ...
        while i < 360:
            if i % 30 == 0 and (i < 150 or i > 210):
                ...
                painter.drawText(
                    -metrics.width(self._pointText[i]) / 2.0, -52,
                    self._pointText[i]
                )
            elif i < 135 or i > 225:
